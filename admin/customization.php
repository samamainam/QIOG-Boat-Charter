    ...
    <div class="wrap qiog-admin-wrap">
        ...
        <form method="post" action="options.php" class="qiog-admin-form">
                ...
                <div class="qiog-admin-section">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="checkout_button_text" name="qiog_customization_options[checkout_button_text]" 
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea id="success_message" name="qiog_customization_options[success_message]" 
                                          rows="3" class="large-text"><?php echo esc_textarea($options['success_message']); ?></textarea>
                ...
                <div class="qiog-admin-section">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <input type="number" id="base_price_3_stops" name="qiog_customization_options[base_price_3_stops]" 
                                       value="<?php echo esc_attr($options['base_price_3_stops']); ?>" min="0" step="50" class="small-text">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" id="base_price_4_stops" name="qiog_customization_options[base_price_4_stops]" 
                                       value="<?php echo esc_attr($options['base_price_4_stops']); ?>" min="0" step="50" class="small-text">
                                <span class="description">$</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="number" id="max_stops" name="qiog_customization_options[max_stops]" 
                                       value="<?php echo esc_attr($options['max_stops']); ?>" min="1" max="10" class="small-text">
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <fieldset>
                                    <label>
                                        <input type="checkbox" name="qiog_customization_options[show_summary_icons]" 
                                               <?php checked($options['show_summary_icons'], 'yes'); ?>>
                                        Show icons in summary sections
                                    </label><br>
                                    <label>
                                        <input type="checkbox" name="qiog_customization_options[show_empty_state]" 
                                               <?php checked($options['show_empty_state'], 'yes'); ?>>
                ...
                <div class="qiog-admin-section">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
                                    <input type="checkbox" name="qiog_customization_options[enable_customer_email]" 
                                           <?php checked($options['enable_customer_email'], 'yes'); ?>>
            ...
            <div class="qiog-submit-wrapper">
                ...
                <button type="button" class="button button-secondary" onclick="if(confirm('Reset all settings to defaults?')) { window.location.href='<?php echo esc_url($reset_url); ?>'; }">
                    Reset to Defaults
                </button>
            </div>
        </form>
